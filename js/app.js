...
const setInnerText = (id, value) => {
  document.getElementById(id).innerText = Math.abs(value,2);
};
...
const updateTaxAndCharge = () => {
  ...
  if (priceConverted > 200) {
    ...
    setInnerText("total-tax", Math.abs(priceConverted * 0.2,2));
  }
  if (priceConverted > 400) {
    setInnerText("delivery-charge", 50);
    setInnerText("total-tax", Math.abs(priceConverted * 0.3,2));
  }
